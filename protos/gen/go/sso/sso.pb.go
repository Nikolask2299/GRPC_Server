...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // email address of the user to register with the service
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password of the user to register with the service
}
...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // id of the user to register with the service
}
...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // email address of the user to login with the service
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // password of the user to login with the service
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // app_id of the user to login with the service
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // token of the user to login with the service
}
...
type IsAdminRequest struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // id of the user to login with the service with the service
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // true if the user is an administrator the service should return true for the user to be an administrator
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x12, 0x73, 0x6b, 0x72, 0x69, 0x70, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
